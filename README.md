...
Simple Phone Book Application using Python

A lightweight, console-based Phone Book Manager built with Python. This project demonstrates how to use Python dictionaries to perform CRUD (Create, Read, Update, Delete) operations on contact data efficiently.
